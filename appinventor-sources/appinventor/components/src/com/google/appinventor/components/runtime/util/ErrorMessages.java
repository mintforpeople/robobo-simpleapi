...
public final class ErrorMessages {
  ...
  public static final int ERROR_SIMPLE_API_SERVICE_NOT_AVALIABLE = 3301;
  public static final int ROBOBO_INTERNAL_ERROR = 3302;
  public static final int ERROR_ROBOBO_VOICE_NOT_FOUND = 3303;
  ...
  static {
    ...
    errorMessages.put(ERROR_SIMPLE_API_SERVICE_NOT_AVALIABLE, "Robobo simple API service not available.");
    errorMessages.put(ROBOBO_INTERNAL_ERROR, "%s");
    errorMessages.put(ERROR_ROBOBO_VOICE_NOT_FOUND, "%s");
